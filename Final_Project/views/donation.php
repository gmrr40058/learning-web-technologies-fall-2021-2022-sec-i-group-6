...
?>
    <body>
        <div>
            ...
            <div style="background-color: cyan; text-align:center; width: 400px;height: 400px; margin: 2px auto; padding: 20px; border: 1px solid black; border-radius:5PX ;">
                <h1>Donation of <?php echo $_COOKIE['fname'] . " " . $_COOKIE['lname'];?></h1>
                <hr>
                <b style="color: red; size: 50;">* You must donate one time to see your donations.</b><br/><br/>
                <form onsubmit="return dvalidateForm()" action="../controller/donatech.php" method="post">
